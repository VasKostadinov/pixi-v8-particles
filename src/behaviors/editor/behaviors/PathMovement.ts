  ...
  props: [
    {
      ...
      title: "Path",
      description:
        'Algebraic expression describing the movement of the particle. Examples: "x * x" or "sin(x)"',
      default: "x",
    },
    {
      type: "numberList",
      ...
      title: "Speed",
      description:
        "Speed of the particles. This affects the x value in the path (before rotation).",
      default: 100,
    },
    {
      type: "number",
